...
--
-- Table structure for table `studentJob`
--
...
--
-- Dumping data for table `studentJob`
--

LOCK TABLES `studentJob` WRITE;
/*!40000 ALTER TABLE `studentJob` DISABLE KEYS */;
INSERT INTO `studentJob` VALUES ('stu1','Neeraj','Rana','developer','3',''),('stu2','Nagamani','Daggu','developer','3','');
